USE [master]
GO
/****** Object:  Database [EjercicioDB]    Script Date: 30-Mar-21 11:44:48 AM ******/
CREATE DATABASE [EjercicioDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'EjercicioDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\EjercicioDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'EjercicioDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\EjercicioDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [EjercicioDB] SET COMPATIBILITY_LEVEL = 140
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [EjercicioDB].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [EjercicioDB] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [EjercicioDB] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [EjercicioDB] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [EjercicioDB] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [EjercicioDB] SET ARITHABORT OFF 
GO
ALTER DATABASE [EjercicioDB] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [EjercicioDB] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [EjercicioDB] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [EjercicioDB] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [EjercicioDB] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [EjercicioDB] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [EjercicioDB] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [EjercicioDB] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [EjercicioDB] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [EjercicioDB] SET  DISABLE_BROKER 
GO
ALTER DATABASE [EjercicioDB] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [EjercicioDB] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [EjercicioDB] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [EjercicioDB] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [EjercicioDB] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [EjercicioDB] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [EjercicioDB] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [EjercicioDB] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [EjercicioDB] SET  MULTI_USER 
GO
ALTER DATABASE [EjercicioDB] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [EjercicioDB] SET DB_CHAINING OFF 
GO
ALTER DATABASE [EjercicioDB] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [EjercicioDB] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [EjercicioDB] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [EjercicioDB] SET QUERY_STORE = OFF
GO
USE [EjercicioDB]
GO
...
CREATE TABLE [dbo].[Customers](
	[CustomerID] [tinyint] PRIMARY KEY NOT NULL,
...
CREATE TABLE [dbo].[Shippers](
	[ShipperID] [tinyint] PRIMARY KEY NOT NULL,
...
CREATE TABLE [dbo].[Orders](
	...
	CONSTRAINT FK_EmployeID FOREIGN KEY ([EmployeeID]) REFERENCES [dbo].[Employees] ([EmployeeID]),
	CONSTRAINT FK_ShipperID FOREIGN KEY ([ShipperID]) REFERENCES [dbo].[Shippers] ([ShipperID])
)
GO
...
CREATE TABLE [dbo].[Products](
	[ProductID] [tinyint] PRIMARY KEY NOT NULL,
	[ProductName] [nvarchar](50) NOT NULL,
	[SupplierID] [tinyint] NOT NULL,
	[CategoryID] [tinyint] NOT NULL,
	[Unit] [nvarchar](50) NOT NULL,
	[Price] [float] NOT NULL,
	CONSTRAINT FK_SupplierID FOREIGN KEY ([SupplierID]) REFERENCES [dbo].[Suppliers] ([SupplierID]),
...
CREATE TABLE [dbo].[OrderDetails](
	[OrderDetailID] [smallint] PRIMARY KEY NOT NULL,
...
USE [master]
GO
ALTER DATABASE [EjercicioDB] SET  READ_WRITE 
GO